...
# --- Carregando e Dividindo a Base de Dados (4 classes na raiz) ---
...
model = keras.Sequential([
    data_augmentation,  # <--- 1. AUMENTO DE DADOS
    keras.layers.Rescaling(1. / 255, input_shape=(image_size[0], image_size[1], 3)),

    keras.layers.Conv2D(32, (3, 3), activation='relu'),
    keras.layers.MaxPooling2D((2, 2)),
    keras.layers.Dropout(0.25),  # <--- 2. DROPOUT ADICIONAL
    ...
    # 3. REGULARIZAÇÃO L2 na camada Densa
...
print("Iniciando o treinamento do modelo CNN Robusta (COVID-19)...")
